...
### Challenge 4: Incorrect Peak vs Non-Peak KPI
**Issue:** Initial seasonal KPI logic was incomplete.  
**Solution:** Explicit season grouping logic was implemented and validated using direct SQL queries.
